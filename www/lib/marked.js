  ...
  if (href.match(imgs)){
    ...
    if (href == text) {
      if (href.indexOf('http://dirtyimg.com/')>-1){
        //href='https://img1.visionindustryit.com/0x0/'+href;
        //https://newmedia.vit.tube/resize/640x480/https://scontent-frt3-2.xx.fbcdn.net/v/t31.0-8/18451703_119604535281306_269245501681123810_o.jpg?oh=bb4511494db5f4fe3aa51e282fe5c361&oe=597629E3
        out = href.replace(imgs, '<img check-image src="https://media.vit.tube/view/0x0/$1$2" class="postimg" />');  
      } else {
        out = href.replace(imgs, '<img check-image src="https://media.vit.tube/view/0x0/$1$2" class="postimg" />');  
      }  
    } else {
    ...
    } else if (href.indexOf('https://visionindustryit.com') === 0 || href.indexOf('https://golos.io') === 0) {
...
Renderer.prototype.image = function(href, title, text) {
  ...
  var out = '<img check-image src="https://newmedia.vit.tube/resize/640x480/' + href + '" alt="' + text + '"';
